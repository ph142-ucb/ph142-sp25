...
### Instructions 
* Due date: Saturday, March 1st at 12:00pm PST with a 2 hour grace period. There will be no late submissions accepted beyond 2:00pm on Saturday.
...
## Questions 23-30 are optional for ADDITIONAL PRACTICE - not for credit! Pay attention to the difference in the autograder output.
...
cd; cd ph142-sp25/lab/lab05; python3.11 turn_in.py
...
5. If the submission fails, try to diagnose the issue using the error messages--if you have problems, post on Ed under the Lab 05 thread.
