...
### Instructions 
* Due date: Saturday, February 8th by 12:00PM noon PST.
...
**6b. [1 point] Does a linear relationship hold for any part of the data? What pattern do you notice?**
...
cd; cd ph142-sp25/lab/lab03; python3.11 turn_in.py
...
5. If the submission fails, try to diagnose the issue using the error messages--if you have problems, post on ed under the Lab 03 Thread.
