...
### Instructions 
* Due date: Saturday, February 1st at 12:00pm PST with a 2 hour grace period.
...
```{r keep-exploring-the-data-1, tags=c()}

# YOUR CODE HERE
```

```{r keep-exploring-the-data-2, tags=c()}

# YOUR CODE HERE
```

```{r keep-exploring-the-data-3, tags=c()}

# YOUR CODE HERE
```

```{r keep-exploring-the-data-4, tags=c()}
...
cd; cd ph142-sp25/lab/lab02; python3 turn_in.py
