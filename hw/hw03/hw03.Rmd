...
### Instructions 
* Solutions will be released by Sunday, February 9th.
...
```{r scatter-plot-with-line, tags=c()}
...
```{r second-regression-mod, tags=c()}
...
```{r more-models-more-outputs, tags=c()}
